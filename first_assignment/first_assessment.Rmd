...
db %>% group_by(Species) %>% summarise("Mean Petal Length" = mean(Petal.Length), "Mean Sepal Length" = mean(Sepal.Length), "Mean Sepal Width" = mean(Sepal.Width))

#After checking the sumarised values, it is necessary to change a numerical variable of the table
